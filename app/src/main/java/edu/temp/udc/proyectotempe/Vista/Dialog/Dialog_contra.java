...
public class Dialog_contra extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.dialog_contra, null);
    ...
    public void SignUp() {
        ...
        final Call<String> login = endpoints.contra(mPasswordView.getText().toString());
        login.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                switch (response.code()) {
                    ...
                    case 500:
                        showProgress(false);
                        Toast.makeText(v.getContext(),"Error al cambiar la contraseña. ",Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        showProgress(false);
