...
public class EditUserDevice extends DialogFragment {
...
private UserDevice userDevice;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.dialog_edit_user_device, null);
        ...
        builder.setView(v);
        userDevice= (UserDevice) getArguments().getSerializable("obj");
        mNombre.setText(userDevice.getNombre());
                mEdad.setText(userDevice.getEdad());
        mApellido.setText(userDevice.getApellido());
        return builder.create();
    }
public static EditUserDevice getInstance(UserDevice userDevice){
    EditUserDevice e= new EditUserDevice();
    Bundle bundle= new Bundle();
    bundle.putSerializable("obj",userDevice);
    ...
    public void SignUp() {
        ...
        final Call<String> login = endpoints.editUserDevice(mNombre.getText().toString().trim(), mApellido.getText().toString(),mEdad.getText().toString(),userDevice.get_id());
