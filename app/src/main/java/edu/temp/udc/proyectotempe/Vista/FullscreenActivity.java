...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tempe = (TextView) findViewById(R.id.tempAla);
        alerta = (TextView) findViewById(R.id.sintomas);
       tempe.setText(getIntent().getStringExtra("data"));

        alerta.setText(getIntent().getStringExtra("sintomas"));
